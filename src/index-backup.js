...
const euDcc = (0, index_1.default)(PUBLIC_KEY_PEM, PRIVATE_KEY_P8, "MOH");
describe("Main Helper Functions", () => {
    it("should be able to decode and verify a signed vaccine cert payload", async () => {
        ...
        const firstVaccineQr = await (0, dcc_sdk_1.debug)(signedPayload[0].qr);
        expect(await (0, dcc_sdk_1.parseCWT)(firstVaccineQr.value[2])).toStrictEqual({
            meta: {
                notarisedOn: "2022-02-26T00:00:00.000Z",
                passportNumber: "E7831177G",
                reference: "abc-cde-cde",
        ...
        const secondVaccineQr = await (0, dcc_sdk_1.debug)(signedPayload[1].qr);
        expect(await (0, dcc_sdk_1.parseCWT)(secondVaccineQr.value[2])).toStrictEqual({
            meta: {
                notarisedOn: "2022-02-26T00:00:00.000Z",
                passportNumber: "E7831177G",
                reference: "abc-cde-cde",
    ...
    it("should be able to decode and verify a signed test cert payload", async () => {
        ...
        const signedPayload = await euDcc.signPayload(payload);
        const testQr = await (0, dcc_sdk_1.debug)(signedPayload[0].qr);
        expect(await (0, dcc_sdk_1.parseCWT)(testQr.value[2])).toStrictEqual({
            meta: {
                notarisedOn: "2022-02-26T00:00:00.000Z",
                passportNumber: "E7831177G",
                reference: "abc-cde-cde",
