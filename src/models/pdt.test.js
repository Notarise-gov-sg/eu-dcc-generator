...
describe("genTestingRecord()", () => {
    it("should produce valid TestingRecord PCR for long test name", () => {
        ...
        expect(() => (0, pdt_1.genTestingRecord)(valid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).not.toThrowError();
        expect((0, pdt_1.genTestingRecord)(valid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toStrictEqual([
            {
                euTestRecord: {
                    ci: "URN:UVCI:01:SG:1ABC-ADV-CDE",
                    co: "SG",
                    is: "MOH",
                    nm: "SARS-CoV-2 (COVID-19) RNA panel - Respiratory specimen by NAA with probe detecti",
    ...
    it("should produce valid TestingRecord for ART record", () => {
        const valid = [validARTTestingRecord[0]];
        expect(() => (0, pdt_1.genTestingRecord)(valid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).not.toThrowError();
        expect((0, pdt_1.genTestingRecord)(valid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toStrictEqual([
            {
                euTestRecord: {
    ...
    it("should throw error there is an invalid testResultCode", () => {
        const invalid = [{
                ...
                testResultCode: "123456" // Invalid test code
            }];
        expect(() => (0, pdt_1.genTestingRecord)(invalid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toThrowError(`Invalid testResultCode (123456) received. Should be one of these values: ["260385009","10828004","260415000","260373001"]`);
    });
    it("should throw error there is an invalid testTypeCode", () => {
        const invalid = [{
                ...validPCRTestingRecord[0],
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                testTypeCode: "123456" // Invalid test type code
            }];
        expect(() => (0, pdt_1.genTestingRecord)(invalid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toThrowError(`Invalid testTypeCode (123456) received. Should be one of these values: ["97097-0","94531-1","94309-2","LP6464-4","LP217198-3"]`);
    });
    it("should throw error if TestingRecords have invalid collectionDateTime format", () => {
        const invalid = [{
                ...validPCRTestingRecord[0],
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                collectionDateTime: "12 Feb 2015" // Invalid collectionDateTime
            }];
        expect(() => (0, pdt_1.genTestingRecord)(invalid, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toThrowError(`Invalid collectionDateTime (12 Feb 2015). Should be ISO-8601 date and time format`);
    });
});
