...
describe("genVaccinationRecord()", () => {
    it("should produce valid VaccinationRecord", () => {
        ...
        expect(() => (0, vac_1.genVaccinationRecord)(validVaccinationRecord, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).not.toThrowError();
        expect((0, vac_1.genVaccinationRecord)(validVaccinationRecord, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toStrictEqual([{ "doseNumber": 1, "euVaccineRecord": { "ci": "URN:UVCI:01:SG:1ABC-ADV-CDE", "co": "SG", "dn": 1, "dt": "2021-02-14", "is": "MOH", "ma": "ORG-100030215", "mp": "EU/1/20/1528", "sd": 2, "tg": "840539006", "vp": "1119349007" }, "expiryDateTime": "2023-02-22T00:00:00.000Z", "vaccineCode": "3339641000133109" }, { "doseNumber": 2, "euVaccineRecord": { "ci": "URN:UVCI:01:SG:2ABC-ADV-CDE", "co": "SG", "dn": 2, "dt": "2021-03-03", "is": "MOH", "ma": "ORG-100030215", "mp": "EU/1/20/1528", "sd": 2, "tg": "840539006", "vp": "1119349007" }, "expiryDateTime": "2023-02-22T00:00:00.000Z", "vaccineCode": "3339641000133109" }]);
    });
    it("should produce valid VaccinationRecord with ios vaccination date time", () => {
        const validVaccinationRecord = {
            vaccinations: [
                {
                    vaccineCode: "3339641000133109",
                    vaccineName: "PFIZER-BIONTECH COVID-19 Vaccine [Tozinameran] Injection",
                    vaccineLot: "Lot12345",
                    vaccinationDateTime: "2021-02-14T06:15:00Z",
                    vaccinationLocationCode: "HIC001",
                    vaccinationCountry: "SG"
                },
                {
                    ...
                    vaccineName: "PFIZER-BIONTECH COVID-19 Vaccine [Tozinameran] Injection",
                    vaccineLot: "Lot97531",
                    vaccinationDateTime: "2021-03-03T06:15:00Z",
                    vaccinationLocationCode: "HIC002",
                    vaccinationCountry: "SG"
                }
            ],
    ...
    it("should produce valid VaccinationRecord with primary series of multiple doses", () => {
        ...
        expect(() => (0, vac_1.genVaccinationRecord)(validVaccinationRecord, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).not.toThrowError();
        expect((0, vac_1.genVaccinationRecord)(validVaccinationRecord, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toStrictEqual([
            {
                "doseNumber": 1,
                "euVaccineRecord": {
    ...
    it("should throw error if VaccinationRecord have invalid vaccinationDateTime format", () => {
        ...
        expect(() => (0, vac_1.genVaccinationRecord)(validVaccinationRecord, "2023-02-22T00:00:00.000Z", "MOH", "abc-adv-cde")).toThrowError(`Invalid vaccinationDateTime (02 Feb 2021). Should be YYYY-MM-DD format`);
    });
});
